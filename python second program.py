...
if answer.lower().strip() == "yes":
    print("Great", name, "you will have to defend the castle from the Knights!")



# function to ask play again or not
def play_again():
  print("Do you want to defend the castle again? (yes/no)")
...
def start():
  # give some prompts.
  print("You have a crossbow with one arrow remaining")
  print("There are two enemeies approaching both sides of the wall, left enemie is climbing the wall, right enemie is knocking the barrier down. Which enemie do you attack(l or r)")
